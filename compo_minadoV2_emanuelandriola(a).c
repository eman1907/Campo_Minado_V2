...
scanf("%d" , &dif); 
//lê a dificuldade do jogo conforme especificado no enunciado;
...
while (scanf("%d,%d" , &x, &y)){ 
	 ...
	 coordenada_errada(log, x, y, 0); //funcao de log.c
	   ...
	   registrar_jogada(log, mat2, n, x, y); //funcao de log.c
...
campo_final(log, mat2, n, ok); //funcao de log.c
fechar_log(log); //funcao de log.c
